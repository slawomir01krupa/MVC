...
namespace SportsStore.UnitTests
{
    ...
    public class UnitTest1
    {
        ...
        public void Can_Add_New_Lines()
        {
            ...
            target.AddItem(p1, 1);
            target.AddItem(p2, 1);
            SportsStore.Domain.Entities.Cart.CartLine[] results = target.Lines.ToArray();
            // Assert
        ...
        public void Can_Add_Quantity_For_Existing_Lines()
        {
            ...
            SportsStore.Domain.Entities.Cart.CartLine[] results = target.Lines.OrderBy(c => c.Product.ProductID).ToArray();
            // Assert
            Assert.AreEqual(results.Length, 2);
